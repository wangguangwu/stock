...
public class MarketQuotesServiceImpl implements MarketQuotesService {
    ...
    @Override
    public boolean dailyMarketQuotes(String tsCode, String tradeDate, String startDate, String endDate) {
        dailyMarketQuotesComponent.setParams(getParams(tsCode, tradeDate, startDate, endDate));
        return dailyMarketQuotesComponent.fetchAndSaveData("A股每日行情");
    }
    ...
    @Override
    public void bakDaily(String tsCode, String tradeDate, String startDate, String endDate) {
        bakDailyComponent.setParams(getParams(tsCode, tradeDate, startDate, endDate));
        bakDailyComponent.fetchAndSaveData("A股备用行情");
    }

    private static JSONObject getParams(String tsCode, String tradeDate, String startDate, String endDate) {
