package com.wangguangwu.datasnowball.generator;
...
public class CodeGenerator {
     ...
     * 项目名称
     */
    private static final String PROJECT_NAME = "data-snowball";

    /**
     * 包名
     */
    private static final String PACKAGE_NAME = "com.wangguangwu.datasnowball";
     ...
     * 数据库配置
     */
    private static final String URL_PATH = "jdbc:mysql://127.0.0.1:3306/snowballdb?useUnicode=true&characterEncoding=utf8&autoReconnect=true&allowMultiQueries=true&useSSL=false";
    ...
    private static void create() {
        // 创建的表名
        String tableName = "main_indicator_item";
